...
#***********Default Values***************************
CDM_configFile = "iris4_cdm\\WLS_DOM_CDM\\config\\amfConfig.xml.vpp"
ACM_configFile = "iris4_acm\\WLS_DOM_ACM\\war_file\\src\main\\resources\\amfConfig.xml"
ACMI_configFile = "iris4_acm\\WLS_DOM_ACMI\\config\\amfConfig.xml.vpp"
...
if config.has_section("DefaultPath"):
	GIT_REPO_PATH = config.get("DefaultPath","GIT_REPO_PATH")
	TIBCO_HOME = config.get("DefaultPath","TIBCO_HOME")

gitPath = input("Please input git repository path\n(Default Path = "+GIT_REPO_PATH+") : ")
if gitPath != "":
	GIT_REPO_PATH = gitPath
print("Git repository path = "+GIT_REPO_PATH+"\n")

tibcoPath = input("Please tibco path\n(Default Path = "+TIBCO_HOME+") : ")
if tibcoPath != "":
	TIBCO_HOME = tibcoPath
print("Tibco path = "+TIBCO_HOME);
print ("\n")
#print "*****QUEUE*******"
CDM_amfConfigPath = GIT_REPO_PATH+CDM_configFile
ACM_amfConfigPath = GIT_REPO_PATH+ACM_configFile
ACMI_amfConfigPath = GIT_REPO_PATH+ACMI_configFile
MainProcessor_amfConfigPath = GIT_REPO_PATH+MainProcessor_configFile
